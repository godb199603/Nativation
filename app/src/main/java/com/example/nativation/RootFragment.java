...
public class RootFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Navigation.findNavController(button)
                .navigate(R.id.action_rootFragment_to_setFragment);
        String nickName = "master";

//        RootFragmentDirections.ActionRootFragmentToSetFragment action=
//                RootFragmentDirections.actionRootFragmentToSetFragment().setNick(nickName);
//
//
//        Navigation.findNavController(button)
//                .navigate(action);
