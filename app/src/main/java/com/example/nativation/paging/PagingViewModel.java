...
/**
 * 作者：Create on 2020/4/2 19:55  by  wzl
 * 描述：
 * 最近修改：2020/4/2 19:55 modify by wzl
 */
public class PagingViewModel extends ViewModel{
    ...
    public void loadData(final int currentPage, final PageKeyedDataSource.LoadInitialCallback<Integer, ArticleResponse.DataBean.DatasBean> initialCallback
            , final PageKeyedDataSource.LoadCallback<Integer, ArticleResponse.DataBean.DatasBean> callback) {
